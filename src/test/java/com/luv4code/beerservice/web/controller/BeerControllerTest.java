...
class BeerControllerTest {
    ...
    void getBeerById() throws Exception {
        ...
        given(beerService.getBeerById(any(), anyBoolean())).willReturn(getValidateBeerDto());
    ...
    void saveNewBeer() throws Exception {
        ...
        given(beerService.saveNewBeer(any())).willReturn(getValidateBeerDto());
    ...
    void updateBeerById() throws Exception {
        ...
        given(beerService.updateBeer(any(), any())).willReturn(getValidateBeerDto());
